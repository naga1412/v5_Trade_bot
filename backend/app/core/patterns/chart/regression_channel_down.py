"""Regression channel down — linear regression with negative slope, ±2σ envelope."""
...
class RegressionChannelDownPattern:
    pattern_id: str = "regression_channel_down"

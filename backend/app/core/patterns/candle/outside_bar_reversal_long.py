...
from app.core.patterns.candle._helpers import compute_rsi_at, is_bullish

_OVERSOLD = 30.0


class OutsideBarReversalLongPattern:
    pattern_id: str = "outside_bar_reversal_long"
    ...
    def detect(
        ...
        if math.isnan(rsi_prev) or rsi_prev >= _OVERSOLD:
            return None
